const LINKS = [
  {
    ...
    text: "group-hover:group-not-[.disabled]:text-lime-300",
    border: "hover:not-[.disabled]:border-lime-300",
    background: "hover:not-[.disabled]:bg-lime-400/10",
    shadow: "hover:not-[.disabled]:shadow-lime-400/10",
    groups: [
      {
        update: '',
  ...
  },
  {
    ...
    text: "group-hover:group-not-[.disabled]:text-amber-300",
    border: "hover:not-[.disabled]:border-amber-300",
    background: "hover:not-[.disabled]:bg-amber-400/10",
    shadow: "hover:not-[.disabled]:shadow-amber-400/10",
    groups: [
      {
        update: '',
  ...
  },
  {
    ...
    text: "group-hover:group-not-[.disabled]:text-rose-300",
    border: "hover:not-[.disabled]:border-rose-300",
    background: "hover:not-[.disabled]:bg-rose-400/10",
    shadow: "hover:not-[.disabled]:shadow-rose-400/10",
    groups: [
      {
        update: '2026-05-07',
  ...
  },
  {
    ...
    text: "group-hover:group-not-[.disabled]:text-violet-300",
    border: "hover:not-[.disabled]:border-violet-300",
    background: "hover:not-[.disabled]:bg-violet-400/10",
    shadow: "hover:not-[.disabled]:shadow-violet-400/10",
    groups: [
      {
        update: '',
  ...
  },
  {
    ...
    text: "group-hover:group-not-[.disabled]:text-sky-300",
    border: "hover:not-[.disabled]:border-sky-300",
    background: "hover:not-[.disabled]:bg-sky-400/10",
    shadow: "hover:not-[.disabled]:shadow-sky-400/10",
    groups: [
      {
        update: '',
        title: "Random Picker",
